...
public class ClassPathUtils {
	...
	public static String getWebinfPath() {
		if (_webinfPath == null) {
			String res = null;
			ClassPathUtils u = new ClassPathUtils();
	...
	public static String getWebRoot() {
		String path = ClassPathUtils.getWebinfPath();
		path = path.substring(0, path.length() - new String("WEB-INF/").length());
		return path;
	}
	...
	public static void main(String ar[]) {
		String system_path = ClassPathUtils.getWebinfPath();
		System.out.println(system_path);
		String system_path2 = ClassPathUtils.getSystemPath();
		System.out.println(system_path2);
		System.out.println(ClassPathUtils.getWebRoot());
