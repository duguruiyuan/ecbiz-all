...
/**
 * 
 * @create.date: Jun 3, 2009 3:08:12 PM
 * @comment:
 *               <p>
 *               TODO
 *               </p>
 ...
 * @author: yuxinrong
 * @modify.by: yuxinrong
 * @modify.date: Jun 3, 2009 3:08:12 PM
 */
public class StringUtil {
	 ...
	 * @comment:
	 * <p>
	 * please description this method to do
	 * </p>
	 * @create.date: Jun 3, 2009 ( 3:08:20 PM )
	 * @author: yuxinrong
	 * @param s
	 * @return 不是数字为true
	 * @see:
	 *         <h1>org.ferrari.utils.StringUtil.isnotNum</h1>
	...
	public static boolean isnotNum(String s) {
		if (s == null)
			throw new UtilsException("字符串为空!" + StringUtil.class);
		Pattern pattern = Pattern.compile("[0-9]*");
		Matcher isdi = pattern.matcher(s);
		if (!isdi.matches()) {
			return true;
		}
		return false;
	 ...
	 * please description this method to do
	 * </p>
	 * @create.date: Jun 3, 2009 ( 3:10:19 PM )
	 * @author: yuxinrong
	 * @param str
	 * @return
	 * @see:
	 *            <h1>org.ferrari.utils.StringUtil.StringFilter</h1>
	 * @modified.by: <if there modified by others,then write author name>
	 * @modified.date: <modified date time>
	 */
	...
	public static final String DEFAULT_GENERAL_SPLITOR = ";, ";
	 ...
	 * @return
	 */
	public static String arrayToSQLSet(String[] array) {
		if (array == null)
			return (null);
	 ...
	 * @return
	 */
	public static String arrayToSQLSet(char[] array) {
	 ...
	 * @return
	 */
	public static String arrayToSQLSet(List<?> list) {
		if (list == null)
			return (null);
		StringBuffer buf = new StringBuffer();
		for (int i = 0; i < list.size(); ++i) {
	 ...
	 * @return
	 */
	public static String arrayToSQLSetWithParentheses(String[] array) {
		if (array == null || array.length == 0)
			return (null);
		StringBuffer buf = new StringBuffer();
		return (buf.append("(").append(arrayToSQLSet(array)).append(")"))
				.toString();
	}
	 ...
	 * @return
	 */
	public static String arrayToSqlSetWithParentheses(char[] array) {
		if (array == null || array.length == 0)
			return (null);
		StringBuffer buf = new StringBuffer();
		return buf.append("(").append(arrayToSQLSet(array)).append(")")
	 ...
	 * @return
	 */
	public static String arrayToSqlSetWithParentheses(List<?> list) {
		if (list == null || list.size() == 0)
			return (null);
		StringBuffer buf = new StringBuffer();
		return buf.append("(").append(arrayToSQLSet(list)).append(")")
				.toString();
	}
	 ...
	 * String result=arrayToSQLBundings(s);
	 * output is: ?,?,?,?
	 * </pre>
	 */
	public static String arrayToSQLBundings(String[] array) {
		if (array == null || array.length == 0)
			return (null);
		StringBuffer buf = new StringBuffer();
		for (int i = 0; i < array.length; ++i) {
	 ...
	 * </pre>
	 */
	public static String arrayToSQLBundings(List<?> list) {
		if (list == null || list.size() == 0)
			return (null);
		StringBuffer buf = new StringBuffer();
		for (int i = 0; i < list.size(); ++i) {
	 ...
	 * </pre>
	 */
	public static String arrayToSQLBundingsWithParentheses(String[] array) {
		if (array == null || array.length == 0)
			return (null);
		StringBuffer buf = new StringBuffer();
		for (int i = 0; i < array.length; ++i) {
		...
		return (buf.append("(").append(arrayToSQLBundings(array)).append(")")
				.toString());
	}
	 ...
	 * @return
	 */
	public static String arrayToSQLBundingsWithParentheses(List<?> list) {
		if (list == null || list.size() == 0)
			return (null);
		StringBuffer buf = new StringBuffer();
		for (int i = 0; i < list.size(); ++i) {
		...
		return (buf.append("(").append(arrayToSQLBundings(list)).append(")")
				.toString());
	}
	 ...
	 * </pre>
	 */
	public static int getRepeatTimesOfPattern(String src, String pat) {
	...
	public static String replaceAll(String source, int startPosition,
		...
		while (source.indexOf(patString, start) != -1) {
			buf
					.append(
							source.substring(subFrom, source.indexOf(patString,
									start))).append(repString);
	 ...
	 */
	public static Map<String, String> mlistToMap(String mlist) {
		if (isEmpty(mlist)) {
			return null;
		}
		Map<String, String> map = new HashMap<String, String>();
		...
		for (int i = 0; i < array.length; i++) {
			...
			if (p != -1) {
				map.put(array[i].substring(0, p).trim(), array[i].substring(
						p + 1).trim());
			} else {
	...
	public static void main(String args[]) throws Exception {
		System.out.println(subGbkString("正正正正正正正正正正正正正正正正正正正正",27)) ;
	}
}
