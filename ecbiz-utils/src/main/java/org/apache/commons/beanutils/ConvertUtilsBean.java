...
import org.apache.commons.beanutils.converters.CommonDataType;
...
public class ConvertUtilsBean {
	...
	public Object convert(Object value, Class clazz, String addin) {
    	if (log.isDebugEnabled()) {
            log.debug("Convert object '" + value + "' to class '" +
                      clazz.getName() + "'");
        }
        ...
        return convertValue(converter, clazz, value, addin);
    }

    @SuppressWarnings("unchecked")
	public Object convert(String[] values, Class clazz, String addin) {
        Class type = clazz;
        if (clazz.isArray()) {
        ...
        for (int i = 0; i < values.length; i++) {
           Array.set(array, i, convertValue(converter, type, values[i], addin));
        }
        return (array);
    }
    
    @SuppressWarnings("unchecked")
	private Object convertValue(Converter converter, Class clazz, Object value, String addin) {
    	if (converter instanceof CommonConverter) {
