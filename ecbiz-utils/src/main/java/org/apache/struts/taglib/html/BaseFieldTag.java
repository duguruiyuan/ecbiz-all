/*
 * $Id: BaseFieldTag.java,v 1.2 2009/08/06 08:58:11 lzc Exp $ 
 *
...
public abstract class BaseFieldTag extends BaseInputTag {
	...
	protected String renderInputElement() throws JspException {
		...
		//kevin: add addin input elements....
		if (getFormat() != null) {
			results.append("<input type=\"hidden\" ");
			results.append("name=\"").append(prepareName()).append("_pattern\" ");
			results.append("value=\"").append(getFormat()).append("\"");
			results.append(this.getElementClose());
		}
	...
	protected String formatValue(Object value) throws JspException {
		//kevin: add type convert....
		value = ConvertUtils.convert(value, String.class, getFormat());
