/*
 * $Id: BaseHandlerTag.java,v 1.2 2009/08/06 08:58:11 lzc Exp $ 
 *
 ...
 *
 * @version $Rev: 168243 $ $Date: 2009/08/06 08:58:11 $
 */
public abstract class BaseHandlerTag extends BodyTagSupport {
	...
	//start add by kevin+++++++++++++++++++++++++++++++++++++++++++++++++++
	private String validexp = null;
	private String format = null;
	private String onpropertychange = null;
	...
	private Class<IterateTag> loopTagSupportClass = null;
    private Method loopTagSupportGetStatus = null;
	private Class<IterateTag> loopTagStatusClass = null;
	...
	private Integer getJstlLoopIndex() {
        if (!triedJstlInit) {
            ...
            try {
                ...
                loopTagSupportGetStatus =
                    loopTagSupportClass.getDeclaredMethod("getLoopStatus", (Class)null);
                ...
                loopTagStatusGetIndex =
                    loopTagStatusClass.getDeclaredMethod("getIndex", (Class)null);
        ...
        if (triedJstlSuccess) {
            try {
                ...
                Object status = loopTagSupportGetStatus.invoke(loopTag, (Object)null);
    ...
    protected void prepareTextEvents(StringBuffer handlers) {
        ...
        //add by lifeijun
        prepareAttribute(handlers, "onpropertychange", getOnpropertychange());
    ...
    protected void prepareOtherAttributes(StringBuffer handlers) {
    	//add by kevin
    	if (getValidexp() != null)
    		handlers.append(" ").append("validexp=\"").append( getValidexp() ).append("\" ");
    }
