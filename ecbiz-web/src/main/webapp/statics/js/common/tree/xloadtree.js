...
webFXTreeConfig.loadingIcon = "/images/tree/loading.gif";
...
function WebFXLoadTree(sText, sXmlSrc, sAction, sBehavior, sIcon, sOpenIcon, dataId,style,url) {
	// call super
...
function WebFXLoadTreeItem(sText, sXmlSrc, sAction, eParent, sIcon, sOpenIcon, dataId,style,url) {
	// call super
...
function _xmlTreeToJsTree(oNode) {
	...
	var jsNode;
	if (src != null && src != "")
		jsNode = new WebFXLoadTreeItem(text, src, action, parent, icon, openIcon, dataId,style,url);
	else
		jsNode = new WebFXTreeItem(text, action, parent, icon, openIcon, dataId,style,url);
	jsNode.open = open;
	if (target != "")
