...
var webFXTreeConfig = {
	...
	folderIcon2      : 'images/foldericon.png',
	openFolderIcon2  : 'images/openfoldericon.png',
...
WebFXTree.prototype.toString = function() {
	...
	var str = "<div id=\"" + this.id + "\" ondblclick=\"webFXTreeHandler.toggle(this);\" class=\"webfx-tree-item\" onkeydown=\"return webFXTreeHandler.keydown(this, event)\">" +
		...
		"<a href=\"" + this.url + "\" id=\"" + this.id + "-anchor\" onfocus=\"webFXTreeHandler.focus(this);\" onblur=\"webFXTreeHandler.blur(this);\"" +
...
function WebFXTreeItem(sText, sAction, eParent, sIcon, sOpenIcon, dataId,style,url) {
	this.base = WebFXTreeAbstractNode;
	this.base(sText, sAction);
	/* Defaults to close */
	if (webFXTreeConfig.usePersistence) {
...
WebFXTreeItem.prototype.remove = function() {
	...
	if ((prevSibling == parentNode) && !(parentNode.childNodes.length)) {
		...
		if( document.getElementById(prevSibling.id + '-plus') ) {
			var iconSrc = document.getElementById(prevSibling.id + '-plus').src;
...
WebFXTreeItem.prototype.toString = function (nItem, nItemCount) {
	...
	if ((this.folder) || (webFXTreeHandler.behavior != 'classic')) {
		if(this._level!=0&&this.childNodes.length>0){
			if (!this.icon) { this.icon = webFXTreeConfig.folderIcon2; }
			if (!this.openIcon) { this.openIcon = webFXTreeConfig.openFolderIcon2; }
		}else{
	...
	var str = "<div id=\"" + this.id + "\" ondblclick=\"webFXTreeHandler.toggle(this);\" class=\"webfx-tree-item\" onkeydown=\"return webFXTreeHandler.keydown(this, event)\">" +
		...
		"<img id=\"" + this.id + "-icon\" class=\"webfx-tree-icon\" src=\"" + ((webFXTreeHandler.behavior == 'classic' && this.open)?this.openIcon:this.icon) + "\" onclick=\"webFXTreeHandler.select(this);\">" +	
		"<a "+style+" href=\"javascript:loadTree('" + this.url + "')\" id=\"" + this.id + "-anchor\" onfocus=\"webFXTreeHandler.focus(this);\" onblur=\"webFXTreeHandler.blur(this);\"" +
		(this.target ? " target=\"" + this.target + "\"" : "") +
		//" >" + label + "</a>"+opText+"</div>" +
		" >" + label + "</a></div>" +
		"<div id=\"" + this.id + "-cont\" class=\"webfx-tree-container\" style=\"display: " + ((this.open)?'block':'none') + ";\">";
