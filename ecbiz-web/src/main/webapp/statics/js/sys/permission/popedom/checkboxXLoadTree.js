 ...
 */
//sAddition extends by kevin
function WebFXCheckBoxLoadTree(sText, sXmlSrc, sAction, sBehavior, sIcon, sOpenIcon, sAddition) {
	// call super
...
function WebFXLoadCheckBoxTreeItem(sText, sValue, sXmlSrc, eParent, sIcon, sOpenIcon, bChecked, disabled, sAddition) {
	// call super	
...
function checkbox_createNode(oNode, parentDisabled){
	...
	var sAddition = oNode.getAttribute("addition");
	
	// create jsNode
	var jsNode;
	if (src != null && src != "")
		jsNode = new WebFXLoadCheckBoxTreeItem(text, value, src, parent, icon, openIcon, checked, disabled, sAddition);
	else
		jsNode = new WebFXCheckBoxTreeItem(text, value, parent, icon, openIcon, checked, disabled, sAddition);
