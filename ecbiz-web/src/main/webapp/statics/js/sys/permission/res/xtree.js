...
WebFXTree.prototype.toString = function() {
	//add by kevin
	var addText = "<a href=\"javascript:openDialogs('add', '0');\">["+webFXTreeConfig.textTypeAdd+"]</a>";
...
WebFXTreeItem.prototype.toString = function (nItem, nItemCount) {
	...
	var addText = "<a href=\"javascript:openDialogs('add', "+tempValue+");\">["+webFXTreeConfig.textTypeAdd+"]</a>";
	var editText = "<a href=\"javascript:openDialogs('edit', "+tempValue+");\">["+webFXTreeConfig.textTypeEdit+"]</a>";
	var delText = "<a href=\"javascript:openDialogs('delete', "+tempValue+");\">["+webFXTreeConfig.textTypeDelete+"]</a>";
	var moveText = "<a href=\"javascript:openDialogs('move', "+tempValue+");\">["+webFXTreeConfig.textTypeMove+"]</a>";
