...
(function () {
    ...
    */
    window.UEDITOR_CONFIG = {
        ...
        , maxImageSideLength: 640                    //上传图片最大允许的边长，超过会自动等比缩放,不缩放就设置一个比较大的值，更多设置在image.html中
        ...
        , toolbars: [
            ['fullscreen', 'source', '|', 'undo', 'redo', '|',
                ...
                'insertimage', 'date', 'time', 'spechars',
