 function atCalendarControl(){
  ...
  this.addCalendarPad=function(){
   document.write("<div id='divCalendarpad' style='position:absolute;top:100;left:0;width:150;height:103;display:none;'>");
   document.write("<iframe frameborder=0 height=103 width=150></iframe>");
   document.write("<div style='position:absolute;top:4;left:4;width:150;height:103;background-color:#336699;'></div>");
   document.write("</div>");
  ...
  this.addCalendarBoard=function(){
   ...
   divBoard.style.cssText="position:absolute;top:0;left:0;width:150px;height:103;border:1 outset;background-color:buttonface;";
   
   var tbBoard=document.createElement("table");
   divBoard.insertAdjacentElement("beforeEnd",tbBoard);
   tbBoard.style.cssText="position:absolute;top:0;left:0;width:150px;height:10;font-size:9pt;";
  ...
  /************** 设置各功能按钮的功能 *********************/
   ...
   calendar.calendarAbout.onclick=function(){return true;}
   /*********** Calendar Head ***************/
   tbCell=trRow.insertCell(1);
   tbCell.colSpan=5;
   tbCell.bgColor="#769CDA";
   tbCell.align="center";
   ...
   calendar.goToday.onclick=function(){
    if(calendar.today[1].toString().length<2) calendar.today[1]="0"+calendar.today[1];
    if(calendar.today[2].toString().length<2) calendar.today[2]="0"+calendar.today[2];
   ...
   for (var i = 0; i < 7; i++) {
    ...
    tbCell.align="center";
    tbCell.width=35;
    tbCell.style.cssText="cursor:default;border:1 solid #E6F0FF;background-color:#E6F0FF;";
   }
   ...
   tbBody.style.cssText="position:relative;top:0;left:0;width:150;height:90;font-size:9pt;"
  ...
  this.insertBodyCell=function(theRow,j,day,targetObject){
   var theCell=theRow.insertCell(j);
   if(j==0) var theBgColor="#FFCC99";
   else var theBgColor="#FFFFFF";
   if(day==calendar.currentDate[2]) var theBgColor="#CCCCCC";
   if(day==calendar.today[2]) var theBgColor="#0000FF";
